...
4. The recommendation (clear and direct, not "it depends")
5. The one thing to do first

### step 5: generate the council report

Save `council-report-[timestamp].html` — a single self-contained HTML file with clean styling.

### step 6: save the full transcript

Save `council-transcript-[timestamp].md` with the complete session.
